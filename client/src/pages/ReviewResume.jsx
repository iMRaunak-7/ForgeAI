import { Edit2, FileText, Sparkles } from 'lucide-react';
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <p className="mt-6 text-sm font-medium">
          Upload the resume to get detailed report. Supports PDF Resume Only.
        </p>
        {/* <textarea
          className="w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300"
          placeholder="Eg: Car, table, etc. Only Single Object "
          required
          rows={4}
          value={object}
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold">Resume Report</h1>
        </div>
        {
          !content ?
          (
